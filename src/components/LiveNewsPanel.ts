...
export const OPTIONAL_LIVE_CHANNELS: LiveChannel[] = [
  ...
  { id: 'livenow-fox', name: 'LiveNOW from FOX', handle: '@livenowfox', fallbackVideoId: '54jA8n3I44A' },
  { id: 'newsmax', name: 'Newsmax', handle: '@NEWSMAX', fallbackVideoId: 'S-lFBzloL2Y', useFallbackOnly: true },
  { id: 'abc-news', name: 'ABC News', handle: '@ABCNews', fallbackVideoId: '7Q37N_GZ-gI' },
  ...
  { id: 'tv-rain', name: 'TV Rain', handle: '@tvrain', fallbackVideoId: 'U86i2N-65fE' },
  { id: 'rt', name: 'RT', handle: '', fallbackVideoId: 'IFAcqaNzNSc' },
  ...
  { id: 'jovem-pan', name: 'Jovem Pan News', handle: '@jovempannews', fallbackVideoId: 'U86i2N-65fE' },
  { id: 'record-news', name: 'Record News', handle: '@RecordNews', fallbackVideoId: 'U86i2N-65fE' },
  { id: 'band-jornalismo', name: 'Band Jornalismo', handle: '@BandJornalismo', fallbackVideoId: 'U86i2N-65fE' },
  ...
  { id: 'milenio', name: 'MILENIO', handle: '@MILENIO', fallbackVideoId: 'U86i2N-65fE' },
  { id: 'noticias-caracol', name: 'Noticias Caracol', handle: '@NoticiasCaracol', fallbackVideoId: 'U86i2N-65fE' },
  { id: 'ntn24', name: 'NTN24', handle: '@NTN24', fallbackVideoId: 'U86i2N-65fE' },
  { id: 't13', name: 'T13', handle: '@Teletrece', fallbackVideoId: 'U86i2N-65fE' },
  // Asia
  { id: 'tbs-news', name: 'TBS NEWS DIG', handle: '@tbsnewsdig', fallbackVideoId: 'aUDm173E8k8' },
  { id: 'ann-news', name: 'ANN News', handle: '@ANNnewsCH', fallbackVideoId: 'U86i2N-65fE' },
  { id: 'ntv-news', name: 'NTV News (Japan)', handle: '@ntv_news', fallbackVideoId: 'U86i2N-65fE' },
  { id: 'cti-news', name: 'CTI News (Taiwan)', handle: '@中天新聞CtiNews', fallbackVideoId: 'U86i2N-65fE' },
  { id: 'wion', name: 'WION', handle: '@WION', fallbackVideoId: 'l11r0fLwZ28' },
  { id: 'ndtv', name: 'NDTV 24x7', handle: '@NDTV', fallbackVideoId: 'U86i2N-65fE' },
  ...
  { id: 'arirang-news', name: 'Arirang News', handle: '@ArirangCoKrArirangNEWS', fallbackVideoId: 'U86i2N-65fE' },
  { id: 'india-today', name: 'India Today', handle: '@indiatoday', fallbackVideoId: 'sYZtOFzM78M' },
  { id: 'abp-news', name: 'ABP News', handle: '@ABPNews', fallbackVideoId: 'U8146u2n6_w' },
  ...
  { id: 'iran-intl', name: 'Iran International', handle: '@IranIntl', fallbackVideoId: 'U86i2N-65fE' },
  { id: 'cgtn-arabic', name: 'CGTN Arabic', handle: '@CGTNArabic', fallbackVideoId: 'U86i2N-65fE' },
  ...
  // Africa
  { id: 'africanews', name: 'Africanews', handle: '@africanews', fallbackVideoId: 'U86i2N-65fE' },
  { id: 'channels-tv', name: 'Channels TV', handle: '@ChannelsTelevision', fallbackVideoId: 'U86i2N-65fE' },
  { id: 'ktn-news', name: 'KTN News', handle: '@ktnnews_kenya', fallbackVideoId: 'RmHtsdVb3mo' },
  { id: 'enca', name: 'eNCA', handle: '@encanews', fallbackVideoId: 'U86i2N-65fE' },
  { id: 'sabc-news', name: 'SABC News', handle: '@SABCDigitalNews', fallbackVideoId: 'U8146u2n6_w' },
  ...
  { id: 'tv5monde-info', name: 'TV5 Monde Info', handle: '@TV5MONDEInfo', fallbackVideoId: 'S-26b2Z5lqM' },
  { id: 'nrk1', name: 'NRK1', handle: '@nrk', fallbackVideoId: 'U86i2N-65fE' },
  { id: 'aljazeera-balkans', name: 'Al Jazeera Balkans', handle: '@AlJazeeraBalkans', fallbackVideoId: 'U86i2N-65fE' },
  // Oceania
