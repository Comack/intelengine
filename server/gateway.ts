...
const RPC_CACHE_TIER: Record<string, CacheTier> = {
  ...
  '/api/climate/v1/get-pollution-grid': 'slow',
  '/api/climate/v1/get-weather-forecast': 'slow',
  ...
  '/api/conflict/v1/list-conflict-incidents': 'slow',
  '/api/conflict/v1/list-situation-reports': 'slow',
  ...
  '/api/research/v1/get-repo-momentum': 'slow',
  '/api/research/v1/list-social-trends': 'slow',
