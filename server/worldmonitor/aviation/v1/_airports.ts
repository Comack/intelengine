// Server-side copy of airport data to avoid importing from src/config (client boundary).
// Keep in sync with src/config/airports.ts when adding or removing airports.
